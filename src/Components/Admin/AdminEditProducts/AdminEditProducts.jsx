        ...
        <Row className="justify-content-start">
          <Col sm="12" md="10">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("priceAfterDiscount", e.target.value)
              }
            />
            ...
            >
              <option value="0">-- اختر تصنيفاً --</option>
              {/* الحماية باستخدام ? لضمان عدم حدوث Error map */}
            ...
            <Select
              ...
              className="react-select-container mt-1"
              options={options}
              // هنا قمنا بتغيير القيمة لترتبط بـ form.subcategories
...
//     colorRemove,
//     handleColorChange,
//     item, // لإظهار اسم المنتج في العنوان إذا أردت
